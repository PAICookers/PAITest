class FrameMask:
    ...
    GENERAL_REPLICATION_ID_OFFSET = 30
    GENERAL_REPLICATION_ID_MASK = (1 << 10) - 1
    GENERAL_REPLICATION_ID_X_OFFSET = 35
    GENERAL_REPLICATION_ID_X_MASK = (1 << 5) - 1
    GENERAL_REPLICATION_ID_Y_OFFSET = GENERAL_REPLICATION_ID_OFFSET
    GENERAL_REPLICATION_ID_Y_MASK = (1 << 5) - 1
